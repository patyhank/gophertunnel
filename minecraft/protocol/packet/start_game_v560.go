...
// StartGamev560 is sent by the server to send information about the world the player will be spawned in. It
...
// ID ...
func (*StartGamev560) ID() uint32 {
	return IDStartGame
}

// Marshal ...
func (pk *StartGamev560) Marshal(w *protocol.Writer) {
...
// Unmarshal ...
func (pk *StartGamev560) Unmarshal(r *protocol.Reader) {
